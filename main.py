...
if __name__ == "__main__":
    ...
    parser.add_argument('--config_file', type=str, help='config file path', required=False)
    parser.add_argument('--dataset', type=str, help='dataset name', required=False)
    args = parser.parse_args()

    print('###################### UltraGCN ######################')

    if args.dataset is not None and args.dataset == "movielens":
        args.config_file = r'./config/ultragcn_movielens1m_m1.ini'
